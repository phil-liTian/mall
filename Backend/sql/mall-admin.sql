-- ============================================================
-- mall-admin 数据库脚本
-- ponytail: 仅含 admin 业务所需 31 张表（UMS+PMS），不含 CMS/OMS/SMS
-- 抽取自 macrozheng/mall 的 mall.sql
-- ============================================================
...
-- ============================================================
-- 初始数据
-- ponytail: ums_admin 仅保留超管 admin（密码 123456，BCrypt cost10）；
--           其余参考账号已剔除。商品演示数据保留以便前端联调。
-- ============================================================

-- ums_admin: 超管（密码 123456）
INSERT INTO `ums_admin` VALUES (1, 'admin', '$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_01.png', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2020-04-20 12:45:16', 1);
...
-- ums_role_resource_relation: 46 行
...
-- ums_role_permission_relation: 17 行
...
-- ums_admin_role_relation: 仅保留 admin(id=1) → 超级管理员(id=5)
INSERT INTO `ums_admin_role_relation` VALUES (1, 1, 5);

-- ums_admin_permission_relation: 无参考数据

-- ums_member_level: 4 行
...
-- pms_product_attribute_category: 12 行
...
-- pms_product_category_attribute_relation: 5 行
...
-- pms_product_full_reduction: 36 行
...
-- pms_product_attribute_value: 130 行
...
-- pms_product_vertify_record: 2 行
