...
import com.phil.mall.service.PmsProductAttributeCategoryService;
...
public class PmsProductAttributeCategoryController {
    ...
    @Operation(description = "添加商品属性分类")
    ...
    @Operation(description = "修改商品属性分类")
    ...
    @Operation(description = "删除单个商品属性分类")
    ...
    @Operation(description = "获取单个商品属性分类信息")
    ...
    @Operation(description = "分页获取所有商品属性分类")
    ...
    @Operation(description = "获取所有商品属性分类及其下属性")
